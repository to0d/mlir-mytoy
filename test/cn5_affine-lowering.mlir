// RUN: mytoy %s -emit=mlir-affine 2>&1 | FileCheck %s
// RUN: mytoy %s -emit=mlir-affine -opt 2>&1 | FileCheck %s --check-prefix=OPT
...
// CHECK:         mytoy.print [[VAL_6]] : memref<3x2xf64>
...
// OPT:         mytoy.print [[VAL_6]] : memref<3x2xf64>
