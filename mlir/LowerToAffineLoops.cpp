...
using AddOpLowering = BinaryOpLowering<mytoy::AddOp, arith::AddFOp>;
using MulOpLowering = BinaryOpLowering<mytoy::MulOp, arith::MulFOp>;
...
struct ReturnOpLowering : public OpRewritePattern<mytoy::ReturnOp> {
  using OpRewritePattern<mytoy::ReturnOp>::OpRewritePattern;

  LogicalResult matchAndRewrite(mytoy::ReturnOp op,
                                PatternRewriter &rewriter) const final {
...
struct TransposeOpLowering : public ConversionPattern {
  TransposeOpLowering(MLIRContext *ctx)
      : ConversionPattern(mytoy::TransposeOp::getOperationName(), 1, ctx) {}
  ...
  matchAndRewrite(Operation *op, ArrayRef<Value> operands,
    ...
    lowerOpToLoops(op, operands, rewriter,
                   [loc](OpBuilder &builder, ValueRange memRefOperands,
                     ...
                     mytoy::TransposeOpAdaptor transposeAdaptor(memRefOperands);
